...
internal class GetCalendarFeedUrlQueryHandler(
    IDatabaseContext db,
    ICurrentUserService currentUserService,
    IHttpContextAccessor httpContextAccessor)
    : IRequestHandler<GetCalendarFeedUrlQuery, GetCalendarFeedUrlQueryResult>
{
    public async Task<GetCalendarFeedUrlQueryResult> Handle(
        GetCalendarFeedUrlQuery request,
        CancellationToken ct)
    {
        ...
        if (employee.CalendarFeedToken == null)
        {
        ...
        return new GetCalendarFeedUrlQueryResult(feedUrl);
    }
}
