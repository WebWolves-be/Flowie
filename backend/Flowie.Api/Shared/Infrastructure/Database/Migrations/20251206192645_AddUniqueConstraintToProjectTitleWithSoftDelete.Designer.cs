...
namespace Flowie.Api.Shared.Infrastructure.Database.Migrations
{
    ...
    [Migration("20251206192645_AddUniqueConstraintToProjectTitleWithSoftDelete")]
    partial class AddUniqueConstraintToProjectTitleWithSoftDelete
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Flowie.Api.Shared.Domain.Entities.Employee", b =>
                {
                    b.HasOne("Flowie.Api.Shared.Domain.Entities.Identity.User", "User")
                        .WithOne("Employee")
                        .HasForeignKey("Flowie.Api.Shared.Domain.Entities.Employee", "UserId")
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("Flowie.Api.Shared.Domain.Entities.Identity.User", null)
                        .WithMany()
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
