...
This document describes how to perform end-to-end testing of the API integration between the Angular frontend and .NET backend.
...
### Test Case 3: Load Tasks for a Project
...
### Test Case 4: Create a New Project
...
1. **No Employee Endpoint**: The `/api/employees` endpoint doesn't exist yet, so employee data falls back to mock data. This is expected behavior.
